...
def compute_per_class_metrics(predictions, targets, class_names):
    ...
    precision = precision_score(targets, predictions, average=None, zero_division="0")  # type: ignore[arg-type]
    recall = recall_score(targets, predictions, average=None, zero_division="0")  # type: ignore[arg-type]
    f1 = f1_score(targets, predictions, average=None, zero_division="0")  # type: ignore[arg-type]
